# Modified by PixelMorph LLC, 2026-09-25: NumPy aliases; output-dir creation and write-failure handling.
...
class ExtractSubprocessor(Subprocessor):
    ...
    def redraw(self):
        ...
        view_rect = (np.array(self.rect) * self.view_scale).astype(np.int64).tolist()
        view_landmarks  = (np.array(self.landmarks) * self.view_scale).astype(np.int64).tolist()
